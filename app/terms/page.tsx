      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="space-y-6 text-sm leading-relaxed text-gray-700">
          <section>
            ...
            <p>本規約は、ポッコリラボ（以下「当社」）が提供する「医療クレームAI」（以下「本サービス」）の利用に関する条件を定めるものです。ユーザーは本規約に同意の上、本サービスをご利用ください。</p>
          </section>
          <section>
            <h2 className="font-bold text-base text-gray-900 mb-2">第2条（免責事項）</h2>
            <p>本サービスは医療機関のクレーム・カスタマーハラスメント対応に関する情報提供を目的としており、弁護士・法律専門家による法律相談の代替ではありません。本サービスの利用により生じた損害について、当社の故意または重過失による場合を除き、一切の責任を負いません。</p>
          </section>
          <section>

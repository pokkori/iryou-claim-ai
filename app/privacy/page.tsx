      ...
      <article className="max-w-3xl mx-auto px-6 py-12">
        ...
        <section className="space-y-8 text-sm text-gray-700 leading-relaxed">
          <div>
            ...
            <p>本サービス「医療クレームAI」（以下「本サービス」）は、ポッコリラボが運営するWebサービスです。</p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li>フォームに入力いただいた情報（クレームの種別・状況など）</li>
          ...
          <div>
            ...
            <p>本サービスが生成するコンテンツはAIによる自動生成であり、情報提供を目的としています。実際のクレーム対応については管理者・法的専門家にご相談ください。</p>
          </div>
